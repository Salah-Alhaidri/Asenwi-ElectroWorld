...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(_("username"), max_length=150, unique=True, null=False, default='default_username')  # Add default value
...
def create_profile(sender, instance, created, **kwargs):
    ...
    if created:
        # Automatically create a profile object and set the username
